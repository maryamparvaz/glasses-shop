...
export default function cartright() {
        ...
        let mylocal = JSON.parse(localStorage.getItem('myProducts2'))
        ...
        return (
                <div className='w-full pl-3 lg:w-[35%]  bg-white h-[420px] pb-10 shadow-ui mt-4 lg:ml-5 flex flex-wrap content-start py-5'>
                        <div className='w-full flex flex-wrap px-3'>
                                ...
                                <div className='w-full flex flex-wrap  border-b border-gray-300 pb-5'>
                                        <div className='w-full flex'>
                                                <input className='text-black w-[70%] h-[50px] text-[20px] pl-3 border border-gray-400 rounded-[5px]' placeholder='Promo code' type="text" name="" value={inp} id="" onChange={(e) => setInp(e.target.value)} />
                                                <button className='w-[110px] sm:w-[120px] h-[50px] bg-yel rounded-[10px] mx-1 sm:mx-3'>Apply</button></div>
                                ...
                                <div className='w-full flex flex-wrap'>
                                        ...
                                        <Link href={'./catalog'}><span className='cursor-pointer text-blue-700 '>Continue Shopping</span></Link>
                                </div>
                        </div>
                </div>
        )
